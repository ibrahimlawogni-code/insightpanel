...
//            Stock SIM | Stock MoMo | Observation |
//            N° SIMs | N° MTNs | Horodatage
// ─────────────────────────────────────────────────────────────
...
function _initSaisiesSheet(sheet) {
  const headers = [
    ...
    'Stock SIM', 'Stock MoMo', 'Observation', 'N° SIMs', 'N° MTNs', 'Horodatage'
  ];
  ...
  sheet.setColumnWidth(7, 90);   // Stock MoMo
