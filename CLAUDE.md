...
Je m'appelle Ibrahim LAWOGNI et je vis à Porto-Novo au Bénin. Je suis Responsable Acquisition (RA) en prestation de service chez ZEPHIR GROUP, distributeur agréé MTN Bénin, spécialisé dans la supervision des équipes terrain, le suivi des KPIs et la conformité opérationnelle sur les communes d'Avrankou-Missérété, Dangbo, Adjohoun et Bonou.

Mon activité principale est de piloter l'acquisition GSM & MoMo et la performance terrain, en assurant la disponibilité des ressources (SIM, MoMo, matériel), le suivi des ventes, la coordination des équipes et la communication institutionnelle avec les partenaires.

Mes objectifs prioritaires actuels sont : renforcer les stocks, améliorer le reporting, coacher les agents, assurer la conformité des bases et développer des outils d'automatisation pratiques.

À long terme, je vise un poste de Responsable Régional ou Directeur des Opérations, tout en contribuant à la transformation digitale et en développant un projet personnel entrepreneurial.

Le domaine où j'ai besoin du plus d'aide en ce moment : automatisation et outils pratiques (tableaux de bord, checklists, applications).
...
└── module-installs/
    └── oscar-install/          # Module d'installation initial
```
...
| `.claude/commands/` | Commandes personnalisées de mon Oscar |
| `.claude/skills/` | Skills (super-pouvoirs) de mon Oscar |
...
**Première fois ?** Lancez `/install module-installs/oscar-install` pour démarrer l'installation interactive.
